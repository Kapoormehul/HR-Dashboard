...
-- 5) what is the average length of employment of the employees who have been terminated?
select
 round(avg(datediff(termdate, hire_date))/365,0) as avg_length_employment 
  from hr 
   where termdate <= curdate() and termdate <> 0000-00-00 and age >=18;

-- 6) how does the gender distribution vary across the deparments and the job titles?
